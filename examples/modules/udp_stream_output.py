try:
  ...
  if (udp_packet_valid[udp_num_packets_i] == 1):
    ...
    udp_data[udp_num_packets_i, 0:udp_num_bytes_i] = udp_source_raw[udp_num_packets_i, 1:1+udp_num_bytes_i]
  ...
  if new:
    print(str(udp_num_bytes_i) + ',' + str(udp_data[udp_num_packets_i]), flush=True)
